...
def main(args):
    ...
    # walks=[[1, 2,4], [1,2, 1],[2,1,3],[3,2,1],[4,1,3]]
...
if __name__ == "__main__":
    ...
    # args = parse_args()
    fin_walk = []
    net_address = '/Users/ragami/Documents/node2vec/data/net'
    txt = ".txt"
    for i in [7, 4, 1, 2, 3, 5, 6]:
        address = net_address + str(i) + txt
        args = parse_args()

        args.input = address
        fin_walk += main(args)

        print ('net' + str(i) + ' walk finished')
    with open('/Users/ragami/Documents/node2vec/data/walk.txt', 'w') as f:
